...
import BookingDetailsForm, { BookingFormData } from "@/components/v1-launch/pricing-components/BookingDetailsForm";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0, 0, 0, 0.8)" }}>
      ...
      >
        <div className="text-center">
          {/* Success Icon */}
          <div className="mx-auto mb-6 w-16 h-16 rounded-full flex items-center justify-center" style={{ background: "#A2CE3A20" }}>
          ...
          <p className="text-white/60 font-sora text-sm mb-6">
            Your clarity session has been booked. A Manager will contact you via email shortly to confirm the details.
          </p>
  ...
  const handleFormSubmit = async (formData: BookingFormData) => {
    ...
    try {
      ...
      if (response.ok && result.status === 'success') {
        ...
        const errorMessage = result.message || 'Failed to book session. Please try again.';
        toast({
          variant: "error",
