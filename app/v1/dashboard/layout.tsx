...
const DocumentIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M18.4398 10.9603L17.7865 13.747C17.2265 16.1537 16.1198 17.127 14.0398 16.927C13.7065 16.9003 13.3465 16.8403 12.9598 16.747L11.8398 16.4803C9.05979 15.8203 8.19979 14.447 8.85313 11.6603L9.50646 8.867C9.63979 8.30033 9.79979 7.807 9.99979 7.40033C10.7798 5.787 12.1065 5.35366 14.3331 5.88033L15.4465 6.14033C18.2398 6.79366 19.0931 8.17366 18.4398 10.9603Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M14.0402 16.9271C13.6269 17.2071 13.1069 17.4404 12.4736 17.6471L11.4202 17.9937C8.77356 18.8471 7.38023 18.1337 6.52023 15.4871L5.66689 12.8537C4.81356 10.2071 5.52023 8.80706 8.16689 7.95372L9.22023 7.60706C9.49356 7.52039 9.75356 7.44706 10.0002 7.40039C9.80023 7.80706 9.64023 8.30039 9.50689 8.86706L8.85356 11.6604C8.20023 14.4471 9.06023 15.8204 11.8402 16.4804L12.9602 16.7471C13.3469 16.8404 13.7069 16.9004 14.0402 16.9271Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M12.4268 9.68652L15.6601 10.5065" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M11.7734 12.2666L13.7068 12.7599" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const SettingIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 6.07292V9.91958C2 11.3329 2 11.3329 3.33333 12.2329L7 14.3529C7.55333 14.6729 8.45333 14.6729 9 14.3529L12.6667 12.2329C14 11.3329 14 11.3329 14 9.92625V6.07292C14 4.66625 14 4.66625 12.6667 3.76625L9 1.64625C8.45333 1.32625 7.55333 1.32625 7 1.64625L3.33333 3.76625C2 4.66625 2 4.66625 2 6.07292Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
const DividerSVG = () => (
  <svg width="228" height="1" viewBox="0 0 228 1" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M216 1V0H12V1V2H216V1Z" fill="url(#paint0_radial_157_3616)" mask="url(#path-1-inside-1_157_3616)"/>
    <defs>
      <radialGradient id="paint0_radial_157_3616" cx="0" cy="0" r="1" gradientTransform="matrix(105.102 3.15959e-08 -1.84669e-05 9.47703 120.342 1)" gradientUnits="userSpaceOnUse">
                ...
                {accountNavLinks.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      style={{
                        backgroundColor: isActive ? "rgba(13, 101, 70, 0.1)" : undefined,
                      }}
                    >
                      <span className="flex-shrink-0">{link.icon}</span>
                      {!isCollapsed && <span>{link.name}</span>}
