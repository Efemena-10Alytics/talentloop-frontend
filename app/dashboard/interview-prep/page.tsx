...
const ChromeExtensionSVG = () => (
  ...
  >
    ...
    />
    <path
      d="M13.0313 25.0313C14.6071 25.0313 16.1675 24.7209 17.6235 24.1178C19.0794 23.5147 20.4022 22.6308 21.5165 21.5165C22.6308 20.4022 23.5147 19.0794 24.1178 17.6235C24.7209 16.1675 25.0313 14.6071 25.0313 13.0313C25.0313 11.4554 24.7209 9.89496 24.1178 8.43905C23.5147 6.98314 22.6308 5.66027 21.5165 4.54597C20.4022 3.43167 19.0794 2.54775 17.6235 1.9447C16.1675 1.34164 14.6071 1.03125 13.0313 1.03125C9.84865 1.03125 6.79641 2.29553 4.54597 4.54597C2.29553 6.79641 1.03125 9.84865 1.03125 13.0313C1.03125 16.2138 2.29553 19.2661 4.54597 21.5165C6.79641 23.767 9.84865 25.0313 13.0313 25.0313Z"
      stroke="#0B0D0F"
      strokeWidth="2.0625"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const AICopilotTabSVG = () => (
  ...
  >
    <path
      d="M8.83911 13.0711C10.2936 13.0711 11.4641 11.9139 11.4641 10.4997V4.49965C11.4641 3.08537 10.2936 1.92822 8.83911 1.92822C7.38465 1.92822 6.21411 3.08537 6.21411 4.49965V10.4997C6.21411 11.9139 7.38465 13.0711 8.83911 13.0711Z"
      fill="currentColor"
      fillOpacity="0.15"
    />
    <path
      d="M17.6786 10.4465C17.6786 10.3286 17.5821 10.2322 17.4643 10.2322H15.8571C15.7393 10.2322 15.6429 10.3286 15.6429 10.4465C15.6429 14.2045 12.5973 17.25 8.83929 17.25C5.08125 17.25 2.03571 14.2045 2.03571 10.4465C2.03571 10.3286 1.93929 10.2322 1.82143 10.2322H0.214286C0.0964286 10.2322 0 10.3286 0 10.4465C0 14.9652 3.39107 18.6938 7.76786 19.2215V21.9643H3.87589C3.50893 21.9643 3.21429 22.3474 3.21429 22.8215V23.7857C3.21429 23.9036 3.28929 24 3.38036 24H14.2982C14.3893 24 14.4643 23.9036 14.4643 23.7857V22.8215C14.4643 22.3474 14.1696 21.9643 13.8027 21.9643H9.80357V19.2349C14.2312 18.7527 17.6786 15.0027 17.6786 10.4465Z"
      fill="currentColor"
    />
    <path
      d="M8.83946 15C11.3546 15 13.393 12.9857 13.393 10.5V4.5C13.393 2.01429 11.3546 0 8.83946 0C6.32428 0 4.28589 2.01429 4.28589 4.5V10.5C4.28589 12.9857 6.32428 15 8.83946 15ZM6.21446 4.5C6.21446 3.08571 7.385 1.92857 8.83946 1.92857C10.2939 1.92857 11.4645 3.08571 11.4645 4.5V10.5C11.4645 11.9143 10.2939 13.0714 8.83946 13.0714C7.385 13.0714 6.21446 11.9143 6.21446 10.5V4.5Z"
      fill="currentColor"
    />
  </svg>
);
...
const HumanCoachesTabSVG = () => (
  ...
  >
    ...
    />
    <path
      d="M10.3333 11.6667C13.2789 11.6667 15.6667 9.27885 15.6667 6.33333C15.6667 3.38781 13.2789 1 10.3333 1C7.38781 1 5 3.38781 5 6.33333C5 9.27885 7.38781 11.6667 10.3333 11.6667Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const TechnicalInterviewSVG = () => (
  ...
  >
    <path
      d="M29.1909 1.5H41.4986V13.8077"
      stroke="#A2CE3A"
      strokeWidth="3"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M41.5 1.5L24.1154 18.8846C23.8278 19.1665 23.4412 19.3244 23.0385 19.3244C22.6358 19.3244 22.2491 19.1665 21.9615 18.8846L14.8846 11.8077C14.597 11.5258 14.2104 11.3679 13.8077 11.3679C13.405 11.3679 13.0184 11.5258 12.7308 11.8077L1.5 23.0385"
      stroke="#A2CE3A"
      strokeWidth="3"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const RecentMockIconSVG = () => (
  ...
  >
    <path
      d="M9.25 20.75C5.243 20.75 3.24 20.75 1.995 19.285C0.75 17.822 0.75 15.464 0.75 10.75C0.75 6.036 0.75 3.679 1.995 2.214C3.24 0.749 5.243 0.75 9.25 0.75C13.257 0.75 15.26 0.75 16.505 2.214C17.507 3.394 17.703 5.151 17.741 8.25M5.75 6.75H12.75M5.75 11.75H8.75"
      stroke="#A2CE3A"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const ViewReportArrowSVG = () => (
  ...
  >
    <path
      d="M9.115 9.654V5.327H0V4.327H9.115V0L16.711 4.827L9.115 9.654Z"
      fill="#A2CE3A"
    />
  </svg>
);
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {practiceCards.map((card, i) => (
          <div
            key={i}
            className="bg-[#FFFFFF0A] backdrop-blur-sm border border-white/10 rounded-[20px] p-6 flex flex-col gap-4"
          >
            <div className="w-[43px] h-[43px] flex items-center justify-center">
              {card.icon}
            </div>
            <div>
              <h3 className="text-white font-mona-sans font-bold text-lg">
                {card.title}
              </h3>
            ...
            <button
              className={`mt-auto w-full py-3 rounded-[10px] font-mona-sans font-semibold text-sm cursor-pointer hover:opacity-90 transition-opacity ${card.buttonColor}`}
            >
              {card.buttonText}
            </button>
          </div>
      ...
      <div>
        <h2 className="text-white font-mona-sans font-bold text-xl mb-4">
          Recent Mock Interviews
        </h2>
        <div className="space-y-4">
          {recentInterviews.map((interview, i) => (
            <div
              key={i}
              className="bg-[#FFFFFF0A] backdrop-blur-sm border border-white/10 rounded-[16px] p-5 flex items-start justify-between"
            >
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  <span className="text-white font-mona-sans font-bold text-base">
                    {interview.company} – {interview.role}
                  </span>
                  <span className="px-3 py-0.5 rounded-full bg-[#A2CE3A]/15 text-[#A2CE3A] text-xs font-mona-sans font-medium">
                    {interview.type}
                  </span>
                </div>
                <p className="text-white/50 font-mona-sans text-sm">
                  {interview.feedback}
                </p>
                <button
                  onClick={() =>
                    router.push(
                      `/dashboard/interview-prep/mock-interview/${interview.id}/report`,
                    )
                  }
              ...
              <div className="flex flex-col items-end gap-1 ml-6">
                <div className="flex items-center gap-2">
                  <RecentMockIconSVG />
                  <span className="text-white font-mona-sans font-bold text-2xl">
                    {interview.score}
                  </span>
                </div>
                <span className="text-white/40 font-mona-sans text-xs">
                  {interview.daysAgo}
                </span>
              </div>
            </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-white/50 font-mona-sans text-sm mb-6">
          Get personalized 1-on-1 coaching from industry professionals
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {coaches.map((coach, i) => (
            <div
              key={i}
              className="bg-[#FFFFFF0A] backdrop-blur-sm border border-white/10 rounded-[20px] p-6"
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-[#A2CE3A] font-mona-sans text-sm">
                    {coach.specialty}
                  </p>
                  <p className="text-white/40 font-mona-sans text-xs">
                    {coach.company}, {coach.experience}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4 mb-5">
                ...
                <span className="text-white/50 font-mona-sans text-sm">
      ...
      <div className="bg-[#FFFFFF0A] backdrop-blur-sm border border-[#A2CE3A]/30 rounded-[20px] p-6">
        <h2 className="text-white font-mona-sans font-bold text-xl mb-5">
          Upcoming Coaching Sessions
        </h2>
...
export default function InterviewPrepPage() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-white font-mona-sans font-bold text-2xl lg:text-3xl">
          Interview Preparation
        </h1>
        <p className="text-white/50 font-mona-sans text-sm mt-1">
          Practice with AI or get coached by humans
        </p>
      </div>
      ...
      <div className="bg-[#FFFFFF0A] backdrop-blur-sm border border-[#A2CE3A]/30 rounded-[20px] p-6 mb-8">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h2 className="text-white font-mona-sans font-bold text-xl">
            Real-Time Interview Assistant
          </h2>
        </div>
        <p className="text-white/60 font-mona-sans text-sm mb-5 max-w-3xl">
          Install our Chrome Extension to get AI copilot support during live
          interviews on Zoom, Google Meet, and Microsoft Teams. Get instant
          suggestions as questions are asked.
        </p>
      ...
      <div className="flex items-center gap-0 border-b border-white/10 mb-8">
        ...
        >
          ...
          {activeTab === "ai" && (
            <span className="absolute bottom-0 left-0 right-0 h-[2px] bg-[#A2CE3A]" />
          )}
        </button>
        <button
