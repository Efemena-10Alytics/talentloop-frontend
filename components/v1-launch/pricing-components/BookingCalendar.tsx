      ...
      >
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-[70%]">
            ...
            {partial && !loading && !error && (
              <div className="mb-3 text-[#A8A8A8] font-mona-sans text-xs">
                Some dates may be temporarily unavailable — try again in a
                moment.
              </div>
            )}
          ...
          <div className="lg:w-[30%] flex flex-col">
            ...
            <div className="flex flex-col gap-2 overflow-y-auto pr-2 clarity-time-scroll max-h-[400px]">
              {loading ? (
                ...
                availableTimesForSelectedDate.map((time) => {
                  ...
                  return (
                    <button
                      ...
                      className="h-12 rounded-[12px] flex items-center justify-center font-mona-sans text-sm font-medium transition-all flex-none"
                      style={
                        isSelected
                          ? {
                              background: "#A2CE3A1A",
