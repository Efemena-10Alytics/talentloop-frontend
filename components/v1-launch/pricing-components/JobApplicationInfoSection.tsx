              ...
              <div className="rounded-[24px] p-6 space-y-6" style={{
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <Select
                      value={formData.hadInterviewsRecently}
                      onChange={(value) => setFormData({ ...formData, hadInterviewsRecently: value })}
                      placeholder="Select"
                      options={interviewOptions.map((option) => ({ value: option, label: option }))}
                    />
                  </div>
