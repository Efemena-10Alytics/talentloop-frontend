...
export default function WhoTalentLoopIsFor() {
  ...
  return (
    <section>
    <div className="overflow-hidden min-h-screen py-7 lg:py-20">
    <section className="relative bg-[#FFFFFF1A] border-2 border-white/10 rounded-[32px] p-3 lg:px-3 lg:py-6">
      {/* Background Text */}
        ...
        <div className="relative bg-[#000000]/40 backdrop-blur-3xl border-2 border-white/10 rounded-[32px] p-8 lg:p-16 overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="text-center mb-12 lg:mb-16">
              <h1 className="text-4xl lg:text-6xl xl:text-7xl font-mona-sans font-bold text-white mb-6">
                WHO TALENTLOOP.AI
                <br />
                IS FOR
              </h1>
            ...
            {/* Trusted Text */}
            <p className="text-center text-white font-sora text-sm lg:text-base mb-8 lg:mb-12">
            ...
            >
              ...
              <div
                ...
                className="flex gap-4 lg:gap-6 overflow-x-auto scrollbar-hide scroll-smooth z-20"
                style={{
                  scrollbarWidth: "none",
                ...
                {[...testimonials, ...testimonials, ...testimonials].map(
                  (testimonial, index) => (
                    ...
                    className="flex items-center gap-2">
                      {/* Avatar */}
                      <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-full bg-gradient-to-br from-[#A2CE3A] to-[#7A9E2A] flex items-center justify-center flex-shrink-0 overflow-hidden">
                        {/* Placeholder for person image */}
                        <img src={testimonial.image} alt="" className="h-20 w-20 rounded-full object-cover" />
                      </div>
                    <div
                      className="flex-shrink-0 flex items-center gap-3 lg:gap-4 bg-white/90 backdrop-blur-sm rounded-full px-4 lg:px-6 py-3 lg:py-4 min-w-[280px] lg:min-w-[400px]"
                    >
                      {/* Text */}
            ...
            <div className="absolute bottom-0 left-1/2 lg:-bottom-10 lg:left-[29%] transform -translate-x-1/2 translate-y-1/2 w-[300px] h-[300px] lg:w-[500px] lg:h-[500px] opacity-30 pointer-events-none z-0">
              <div
                className="w-full lg:w-[1000px] h-full rounded-t-full"
                style={{
                  background:
                    "#A2CE3A",
                }}
