...
export default function WhoTalentLoopIsFor() {
  ...
  return (
    ...
    >
      ...
      <section className="w-full flex flex-col items-center">
          <section className="relative w-fit h-fit flex flex-col items-center bg-[#FFFFFF1A] border-2 border-white/80 rounded-[32px] p-3 lg:px-3 lg:py-6">
            {/* Background Text */}
            ...
            <div className="relative w-[1000px] px-3 lg:px-6">
              ...
              <div className="relative bg-[#000000]/40 backdrop-blur-3xl border-2 border-white/10 rounded-[32px] py-3 lg:pt-20 lg:pb-7 overflow-hidden">
                ...
                <div className="relative w-full">
                  ...
                  <div className="absolute hidden lg:block lg:bottom-5 left-1/2 lg:left-[0%] z-0">
                    <img
                      src="/homepage/Ellipse 209.png"
                      alt=""
