...
export default function JobSearchCTASection() {
  return (
    <motion.section
      ...
      className="relative bg-black py-7 lg:pt-12 overflow-hidden"
    >
      <div className="max-w-[1400px] mx-auto px-3 lg:px-6 lg:mb-40">
        {/* Main Container */}
        <div
          style={{
            background: "url('/homepage/Frame 1321318254.svg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
            backgroundRepeat: "no-repeat",
          }}
          className="relative bg-[#E8FFB1] rounded-[32px] lg:rounded-[48px]"
        >
          {/* Content Grid */}
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-12 items-center p-4 lg:p-8">
            {/* Left Side - Content */}
            ...
            <div className="relative hidden lg:block">
              <div className="z-10 absolute lg:-top-[165px] 2xl:-top-[140px] right-0 2xl:right-28">
                <img
                  src="/homepage/Frame 1321318255.svg"
                  alt="Professional in video call"
                  className="object-cover h-[450px] w-full rounded-[24px]"
                />
              </div>
            </div>
          </div>
