...
const features = [
  {
    ...
    bars: [
      { color: "#A2CE3A", filled: true },
      { color: "#E5E7EB", filled: false },
      { color: "#E5E7EB", filled: false },
      { color: "#E5E7EB", filled: false },
    ],
  },
...
export default function WhyTalentLoopDifferent() {
  ...
  return (
    <section className="relative bg-[#0B0D0F] py-7 lg:py-20 overflow-hidden">
            ...
            <div className="relative">
              <div className="bg-[#FFFFFF1A] backdrop-blur-lg border border-[#FFFFFF] rounded-[24px] p-6 lg:p-8 transition-all duration-500">
                ...
                <div className="flex gap-3 lg:gap-4">
                  {currentFeature.bars.map((bar, index) => (
                    <div
                      key={index}
                      className="flex-1 h-3 lg:h-4 rounded-full overflow-hidden transition-all duration-700"
                      style={{
