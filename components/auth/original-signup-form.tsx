...
const coachSlides = [
  ...
  },
  {
    ...
    caption:
      "Set your availability, and build a\nreputation as a trusted career mentor.",
  },
];

interface OriginalSignupFormProps {
  type: string;
  isEmailVerification: boolean;
}

export default function OriginalSignupForm({ type, isEmailVerification }: OriginalSignupFormProps) {
      ...
      await signIn(provider, {
        callbackUrl:
          type === "coach"
            ...
            : "/complete-your-profile/jobseeker",
      });
    } catch (error) {
      toast({
        variant: "error",
