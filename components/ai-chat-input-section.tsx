...
export default function AIChatInputSection() {
  ...
  const dropdownOptions = [
    ...
    { icon: "🎥", label: "Upload Video" },
    { icon: "🔗", label: "Add Link" },
  ];

  return (
    <section className="bg-[#0B0D0F] py-7 lg:py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto lg px-3 lg:px-6 relative z-10">
        {/* Orb Image */}
        ...
        <div className="bg-[#F0F0F00A] border-2 border-[#A2CE3A] rounded-[24px] p-3 lg:p-6 mb-6">
          {/* Input Area */}
          <div className="mb-4">
            <textarea
              placeholder="Type your prompt here..."
              className="w-full text-white bg-transparent placeholder-gray-500 font-sora text-sm outline-none resize-none"
              rows={4}
              value={inputValue}
