          ...
          <div className="z-10 bg-[#F0F0F00A] border-2 border-[#A2CE3A] rounded-[24px] p-3 lg:p-6 mb-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Start Button */}
                <button className="px-8 py-2.5 rounded-[100px] bg-[#A2CE3A] text-black font-mona-sans text-sm font-semibold flex items-center gap-2 hover:bg-[#92BE2A] transition-colors">
                  <SVG1 />
                  Start
                </button>
              </div>
